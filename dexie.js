...
(function (global, factory) {
  ...
  function props(proto, extension) {
    ...
    (typeof Reflect === "undefined" ? keys : Reflect.ownKeys)(
      extension
                  ...
                  for (var i = 0; i < count; ++i) {
                    ...
                    if (modifyer.call(ctx_1, ctx_1.value, ctx_1) !== false) {
                      if (ctx_1.value == null) {
                        ...
                        !outbound &&
                        cmp(extractKey(origValue), extractKey(ctx_1.value)) !==
                          0
                      ) {
                        deleteKeys.push(keys[offset + i]);
                      ...
                      return (
                        ...
                        coreTable
                          .mutate({
                            ...
                            criteria: criteria,
                            changeSpec:
                              typeof changes !== "function" && changes,
                          })
                          .then(function (res) {
  ...
  var Transaction = (function () {
    ...
    Transaction.prototype.table = function (tableName) {
      ...
      var transactionBoundTable = new this.db.Table(
        tableName,
        tableSchema,
        this
      );
          ...
          req.onsuccess = wrap(function (ev) {
            ...
            if (_cursorContinuePrimaryKey)
              _cursorContinuePrimaryKey =
                _cursorContinuePrimaryKey.bind(cursor);
  ...
  function setApiOnPlace(_a, objs, tableNames, dbschema) {
    ...
    tableNames.forEach(function (tableName) {
      ...
      objs.forEach(function (obj) {
        ...
        if (
          !propDesc ||
          ("value" in propDesc && propDesc.value === undefined)
        ) {
          if (
            obj === db.Transaction.prototype ||
            obj instanceof db.Transaction
          ) {
                ...
                if (!queriedIndex.isPrimaryKey) {
                  if (method === "count") {
                    ...
                    var keysPromise_1 =
                      ...
                      req.values &&
                      table.query(
                        __assign(__assign({}, req), { values: false })
                      );
                    return table[method]
  ...
  var Dexie$1 = (function () {
    function Dexie(name, options) {
      ...
      this._createTransaction = function (
        ...
        return new _this.Transaction(
          ...
          storeNames,
          dbschema,
          _this._options.chromeTransactionDurability,
          parentTransaction
        );
      };
      ...
      return this.idbdb &&
        ...
        : new DexiePromise(function (resolve, reject) {
            if (_this._state.openComplete) {
              return reject(
                new exceptions.DatabaseClosed(_this._state.dbOpenError)
              );
            }
    ...
    Dexie.prototype.unuse = function (_a) {
      ...
      if (stack && this._middlewares[stack]) {
        this._middlewares[stack] = this._middlewares[stack].filter(function (
          mw
        ) {
          return create
            ? mw.create !== create
